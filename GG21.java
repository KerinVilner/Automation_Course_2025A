	...
	public static void main(String[] args) {
		...
		while (run) {
			...
			case "1":
				...
				if (decimalInput.trim().isEmpty()) {
					System.out.println("Invalid input. Please enter a non-empty decimal number.");
					continue;
				}
			...
			case "2":
				...
				// check if the input is empty 
				if (hexInput.trim().isEmpty()) {
					System.out.println("Invalid input. Please enter a non-empty hexadecimal number.");
					continue;
				}
